...
public class RestartJVMshutdownhook extends Thread {
    ...
    public void restart() {
        ...
        // Force gc (attempt to ensure that the new instance of server will have
        // enough mem)
        System.gc();
        System.gc();
        // Start process
        try {
            ...
            final File restartscript = new File(crashrestartscriptpath);
            if (!crashrestartscriptpath.isEmpty() && restartscript.exists()) {
                ...
                System.out
                        .println("[AutoSaveWorld] Startup script not found. Restarting without it. This may work strange or not work at all");
                System.out.flush();
                ...
                final List<String> execsequence = new ArrayList<String>();
